...
- [Musiview](Musiview) - General frontend, suitable for visual artists / photographers, writers

While `Musiview` can already support _any_ context with some creativity, other ideas include:
